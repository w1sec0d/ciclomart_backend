...
-- -----------------------------------------------------
-- Table `ciclomart`.`tiendaproducto`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ciclomart`.`tiendaproducto` (
  `idTienda` INT NOT NULL,
  `idProducto` INT NOT NULL,
  ...
  CONSTRAINT `tiendaproducto_ibfk_1`
    FOREIGN KEY (`idTienda`)
    REFERENCES `ciclomart`.`tienda` (`idTienda`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `tiendaproducto_ibfk_2`
...
CREATE TABLE IF NOT EXISTS `ciclomart`.`calificacion` (
  ...
  INDEX `idTienda` (`idTienda` ASC, `idProducto` ASC) VISIBLE,
  INDEX `idProducto` (`idProducto` ASC, `idUsuarioVendedor` ASC) VISIBLE,
  ...
  CONSTRAINT `calificacion_ibfk_2`
    ...
    REFERENCES `ciclomart`.`tiendaproducto` (`idTienda` , `idProducto`)
    ON DELETE CASCADE,
  CONSTRAINT `calificacion_ibfk_3`
    FOREIGN KEY (`idProducto` , `idUsuarioVendedor`)
    REFERENCES `ciclomart`.`documentoproducto` (`idProducto` , `idUsuario`)
    ON DELETE CASCADE)
ENGINE = InnoDB
AUTO_INCREMENT = 2;
...
CREATE TABLE IF NOT EXISTS `ciclomart`.`carritoproducto` (
  ...
  INDEX `idTienda` (`idTienda` ASC, `idProducto` ASC) VISIBLE,
  INDEX `idProducto` (`idProducto` ASC, `idUsuario` ASC) VISIBLE,
  ...
  CONSTRAINT `carritoproducto_ibfk_2`
    ...
    REFERENCES `ciclomart`.`tiendaproducto` (`idTienda` , `idProducto`)
    ON UPDATE CASCADE,
  CONSTRAINT `carritoproducto_ibfk_3`
    FOREIGN KEY (`idProducto` , `idUsuario`)
    REFERENCES `ciclomart`.`documentoproducto` (`idProducto` , `idUsuario`)
    ON UPDATE CASCADE)
ENGINE = InnoDB
AUTO_INCREMENT = 3;
...
CREATE TABLE IF NOT EXISTS `ciclomart`.`mensaje` (
  ...
  INDEX `idUsuarioReceptor` (`idUsuarioReceptor` ASC) VISIBLE,
